...
public class ProfilePage2 extends JFrame {
	...
	public ProfilePage2() throws IOException{
		...
		JButton btnExistingData_2 = new JButton("Import Data");
		btnExistingData_2.setBounds(325, 444, 177, 87);
		btnExistingData_2.setForeground(Color.WHITE);
		btnExistingData_2.setFont(new Font("Arial", Font.BOLD, 15));
		btnExistingData_2.setBackground(new Color(250, 128, 114));
		btnExistingData_2.setVisible(false);
		contentPane.add(btnExistingData_2);
